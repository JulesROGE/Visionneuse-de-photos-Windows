...
#pragma region Windows Form Designer generated code
		   ...
		   void InitializeComponent(void)
		   {
			   ...
			   this->rdb_effacer->CheckedChanged += gcnew System::EventHandler(this, &MyForm::rdb_effacer_CheckedChanged);
			   // 
			   // rdb_coiperEffacer
			   // 
...
#pragma endregion
	...
	private: System::Void btn_source_Click(System::Object^ sender, System::EventArgs^ e) //Cahngé
	{
		int i;

		this->svcFichier = gcnew NS_services::CLserviceFichier(); //Changé
	...
	private: System::Void btn_proceder_Click(System::Object^ sender, System::EventArgs^ e)
	{
		...
		else if (this->rdb_effacer->Checked == true)
		{
			...
			this->txt_rslt->Text = "Les fichiers ont été supprimés depuis l'emplacement : " + this->txt_source->Text;
		}
	...
	private: System::Void rdb_effacer_CheckedChanged(System::Object^ sender, System::EventArgs^ e) {
	}
};
}
